...
class Asar_ClientHttpTest extends Asar_Test_Helper {
  ...
  function testClientShouldSetServer() {
    $this->assertEquals(
  ...
  function testSetServerRemovesTrailingSlashes() {
  ...
  function testGetShouldReturnTheCorrectResponse() {
    $this->client->setServer($this->server);
  ...
  function testMakeRawHttpRequestString() {
    $R = new Asar_Request;
  ...
  function testMakeRawHttpRequestStringRandomValues() {
    $R = new Asar_Request;
    $R->setMethod('POST');
    $headers = array();
  ...
  function testMakeRawHttpRequestStringWithPostValues() {
    $R = new Asar_Request;
    $R->setMethod('POST');
  ...
  function testMakeRawHttpRequestStringWithPostValuesBetter() {
    $R = new Asar_Request;
    $R->setMethod('POST');
  ...
  function testMakeRawHttpRequestShouldHaveNoContent() {
    $R = new Asar_Request;
  ...
  function testRequestHttpShouldSetHostHeader() {
    $R = new Asar_Request;
    $rand = Asar_Utility_RandomStringGenerator::instance();
  ...
  function testRequestHttpShouldSetConnectionHeaderToClose() {
    $R = new Asar_Request;
  ...
  function testRequestingPassesWhateverValueFromCrhrsToSrhr() {
    $client = $this->getMock(
      'Asar_Client', 
      array(
        'createRawHttpRequestString', 'sendRawHttpRequest', 
        'exportRawHttpResponse'
      )
    );
    $R = array('yoyo');
  ...
  function testSrhrDoesNotRunWhenCrhrsReturnsNull() {
    $client = $this->getMock(
      'Asar_Client', 
  ...
  function testSendRawHttpRequest() {
    $rstr = "GET / HTTP/1.1\r\n" .
  ...
  function testSendRawHttpRequestBetter() {   
  ...
  function testSendRawHttpRequestException($site = 'an.unknown.site') {
    $this->client->setServer("http://$site");
    $this->setExpectedException(
      'Asar_Client_Exception', "Unable to connect to $site:80."
    );
    $this->client->GET('/');
  }
  
  function testRawHttpRequestsWithKnownSite($site = 'asar-test.local') {
    $this->client->setServer("http://$site");
    $this->client->GET('/');
  }
  
  function testSendRawHttpRequestUsesClientSetServer() {
    $sites = array(
  ...
  function testExportRawHttpResponse($params = array()) {
    $defaults = array(
       'content' => 'Hello World',
       'status'  => 200
    );
  ...
  function testExportRawHttpResponseWithContentContainingCrlfSequence() {
    $params = array(
  ...
  function testErhrWithADifferentStatusCode() {
    $this->testExportRawHttpResponse(array('status' => 201));
  }
  
  function testRequestingPassesWhateverValueFromSrhrErhr() {
    $client = $this->getMock(
  ...
  function testRequestingReturnsWhateverResultsFromErhr() {
  ...
  function testSendHttpRequestTxt() {
    $this->client->setServer($this->server);
