...
class Asar_TemplateTest extends Asar_Test_Helper {
	...
	public function testGettingTemplateFileExtension()
	{
		$this->assertEquals(
	...
	public function testSettingLayoutWrapsLayoutAroundTemplate()
	{
        $this->T->set(array(
            'h1' => 'Another heading',
	...
	public function testForcingNotToRenderLayout()
	{
	    $this->T->set(array(
            'h1' => 'Another heading',
            'paragraph' => 'Dummy text. Lorem ipsum dolor.'
	...
	public function testLayoutMustNotRenderIfTheLayoutFileDoesNotExist()
	{
	    $this->T->set(array(
	...
	public function testAccessingLayoutVariable()
	{
	...
	public function testAccessingLayoutVariableBeforeSettingLayoutFile()
	{
	    $this->T->set(array('h1' => 'Foo', 'paragraph' => 'Bar'));
	    $this->T->setTemplateFile(self::$template2_path);
	    $this->T->getLayout()->title = 'FooBar Title';
  ...
  public function testAttemptingToRenderANonExistentFileWillRaiseException() {
