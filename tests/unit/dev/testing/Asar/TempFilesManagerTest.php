...
class Asar_TempFilesManagerTest extends PHPUnit_Framework_TestCase {
  
  function setUp() {
    $this->tempdir_parent = realpath(dirname(__FILE__) . '/../../../../data');
  ...
  function testInitializing() {
    $this->assertContains(
      realpath(dirname(__FILE__) . '/../../../..'), $this->tempdir_parent
    );
