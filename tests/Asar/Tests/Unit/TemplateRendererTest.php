...
class TemplateRendererTest extends \Asar\Tests\TestCase {
  
  function setUp() {
    $this->tpp = $this->quickMock('Asar\TemplatePackageProvider');
    $this->tsr = $this->quickMock('Asar\TemplateSimpleRenderer');
    $this->tpl = $this->quickMock('Asar\Template\TemplateInterface');
