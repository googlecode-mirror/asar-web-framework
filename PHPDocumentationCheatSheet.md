...
```
     ...
     * Method summary
     *
     * A more thorough description of the method
     * and what it can do. This description can span
     * multiple lines.
     *
     * @param datatype $parameter_name description of the parameter
     * @param datatype1|dataytype2 $parameter2_name description of the parameter with 2 possible datatypes
     * @return datatype description of the return value
     **/
    public function setLayout($parameter_name, $parameter2_name)
    {
        // Some Code
    }
...
```
phpdoc -s on -d core -t docs -o HTML:frames:DOM/earthli
```